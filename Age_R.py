...
age, radius= np.loadtxt(MESA_file, usecols=(1,11), unpack=True)
...
p.circle('radius','age', size=5, source = source, 
         color='green',  fill_alpha=0.8) #line_color="black",
#p.x_range.flipped = True

output_file("Age_R.html", title="Bokeh HR plot example")#, mode='inline')
show(p)
